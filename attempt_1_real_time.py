...
def predict_deepfake(frame, model):
    # Preprocess the frame (assuming it's in the shape expected by the model)
    ...
    # Get the predicted class index (0 for Real, 1 for Fake)
...
# Open a video capture stream (you can modify the source, 0 for default camera)
